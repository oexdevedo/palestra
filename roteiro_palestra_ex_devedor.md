...
```mermaid
gantt
    title Divisão do Tempo da Palestra (40 Minutos)
    dateFormat  m
    axisFormat %M min
    section Palestra
    1. Introdução e Choque de Realidade (Slides 1-5)  :active, 0, 5
    2. O Futuro - Conexão com Sonhos (Slides 11-12)    : 5, 12
    3. O Presente - A Metáfora do Tempo (Slides 13, 17-18) : 12, 22
    4. O Passado - Crenças e Traumas (Slides 14-16)    : 22, 28
    5. A Revolução - Organização e Métodos (Slides 6-9, 19-24) : 28, 38
    6. Conclusão e Call to Action (Slide 25)          : 38, 40
```
